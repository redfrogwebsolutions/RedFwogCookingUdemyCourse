...
{
    public class FakeWebsitePageRepository : IWebsitePageRepository
    {
        ...
        List<WebsitePage> pages = new List<WebsitePage>
        {
            new WebsitePage()
            {
                ...
                Texts = new List<Text> {
                    ...
                    {
                        Title = "About us Fake",
                        TextContent = " <h1 class=\"mb-4\">Welcome to fake <i class=\"fa fa-utensils text-primary me-2\"></i>Red Frog Cooking</h1>\r\n                <p class=\"mb-4\">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos erat ipsum et lorem et sit, sed stet lorem sit.</p>\r\n                <p class=\"mb-4\">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>"
             ...
             new WebsitePage()
            {
                ...
                Texts = new List<Text> {
                    new Text()
                    {
                        Title = "About us on about us page Fake",
                        TextContent = " <h1 class=\"mb-4\">Welcome to fake <i class=\"fa fa-utensils text-primary me-2\"></i>Red Frog Cooking</h1>\r\n                <p class=\"mb-4\">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos erat ipsum et lorem et sit, sed stet lorem sit.</p>\r\n                <p class=\"mb-4\">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>"
